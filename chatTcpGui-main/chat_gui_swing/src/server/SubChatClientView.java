...
public class SubChatClientView extends javax.swing.JFrame {
    ...
    public HomeChatServer getHome() {
		return home;
	}

	public void setHome(HomeChatServer home) {
		this.home = home;
	}
    ...
    private HomeChatServer home;
    private javax.swing.JPanel title;

    public SubChatClientView() {
        initComponents();
        init();
        setVisible(true);
    }
