...
public class Controller implements ActionListener {
	...
	private String host = "localhost"; // sử dụng địa chỉ ip để kết nối  // localhost chạy trên máy.
			...
			public void sendMessage(String text) {
				...
				if (view.getHome().getChat().getChatTitle().getUserDes() == null) {
					...
					if (isSendFile) {
						...
						String destinationDir = "D:\\NAM3_HK1\\LAPTRINHMANG\\CUOIKI\\chatTcpGui-main\\Server\\";
